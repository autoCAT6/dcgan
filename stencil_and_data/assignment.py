...
from tensorflow.keras.layers import Dense, Flatten, Conv2D, BatchNormalization, LeakyReLU, Reshape, Conv2DTranspose, Dropout
...
class Generator_Model(tf.keras.Model):
    ...
    def call(self, inputs):
        ...
        generated_images = self.gen(inputs)
...
def train(generator, discriminator, dataset_iterator, manager):
    ...
    for iteration, batch in enumerate(dataset_iterator):
        ...
        noise = tf.random.normal([generator.batch_size, generator.z_dim])

        with tf.GradientTape() as gen_tape, tf.GradientTape() as disc_tape:
            gen_output = generator.call(noise)
            real_output = discriminator.call(batch)
            fake_output = discriminator.call(gen_output)
